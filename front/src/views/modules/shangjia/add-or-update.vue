    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shangjiaYesnoTypes" label="审核" prop="shangjiaYesnoTypes">
                        <el-input v-model="ruleForm.shangjiaYesnoValue" placeholder="审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="24">

...
public class MeizhuangOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public MeizhuangOrderEntity() {

	}

	public MeizhuangOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "MeizhuangOrder{" +
            "id=" + id +
            ", meizhuangOrderUuidNumber=" + meizhuangOrderUuidNumber +
            ", addressId=" + addressId +
            ", meizhuangId=" + meizhuangId +
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", meizhuangOrderTruePrice=" + meizhuangOrderTruePrice +
            ", meizhuangOrderCourierName=" + meizhuangOrderCourierName +
            ", meizhuangOrderCourierNumber=" + meizhuangOrderCourierNumber +
            ", meizhuangOrderTypes=" + meizhuangOrderTypes +
            ", meizhuangOrderPaymentTypes=" + meizhuangOrderPaymentTypes +

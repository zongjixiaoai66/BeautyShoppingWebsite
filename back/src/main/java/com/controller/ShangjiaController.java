...
//                            shangjiaEntity.setShangjiaYesnoTypes(Integer.valueOf(data.get(0)));   //审核 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(shangjia.getShangjiaYesnoTypes() == 1 || shangjia.getShangjiaYesnoTypes() == 3)
            return R.error("账户未审核或者未通过审核");
        //  // 获取监听器中的字典表
